 ...
 */
class FixedRentalNameId extends AbstractModifier
{
    const DATA_SCOPE = 'name_id';
    const DATA_SCOPE_FIXEDDATES = 'name_id';
    const GROUP_FIXEDDATES = 'name_id-fixeddates';
    ...
    public function modifyData(array $data)
    {
        ...
        if ($idName) {
            ...
            if ($fixedName->getId()) {
                $data[$idName][$dataScope] = $fixedName->getNameId();
            }
        }
