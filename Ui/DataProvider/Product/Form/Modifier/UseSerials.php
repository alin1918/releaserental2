 ...
 */
class UseSerials extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_serial_numbers_use';
    ...
    protected function customize(array $meta)
    {
        ...
        $tooltip = [
            'description' => __(
                'If set to yes Serial Numbers are used. Serial numbers number should be equal to the qty'
            ),
        ];
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'component' => 'SalesIgniter_Rental/js/form/element/disable-toggle-serials',
                                ],
                            ],
                        ],
                    ],
