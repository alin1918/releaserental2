 ...
 */
class FixedLength extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_fixed_length';
    ...
    public function modifyData(array $data)
    {
        ...
        $configValue = $this->helperCalendar->getFixedLength(null, true);
        if ('' === $value || $value == \SalesIgniter\Rental\Helper\Data::USE_CONFIG_DEFAULT) {
            $data[$modelId][static::DATA_SOURCE_DEFAULT][static::FIELD_MESSAGE_AVAILABLE] = $configValue;
