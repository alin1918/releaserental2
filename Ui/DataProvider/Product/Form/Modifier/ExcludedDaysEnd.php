 ...
 */
class ExcludedDaysEnd extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_excludeddays_end';
    ...
    public function modifyData(array $data)
    {
        ...
        if ('' === $value || in_array(\SalesIgniter\Rental\Helper\Data::USE_CONFIG_DEFAULT, $value)) {
            $data[$modelId][static::DATA_SOURCE_DEFAULT][static::FIELD_MESSAGE_AVAILABLE] =
                $this->helperCalendar->getDisabledDaysWeekEnd(null, true);
