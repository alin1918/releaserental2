 ...
 */
class AlwaysShow extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_always_show';
    ...
    public function modifyData(array $data)
    {
        ...
        if ('' === $value || $value == \SalesIgniter\Rental\Helper\Data::USE_CONFIG_DEFAULT) {
            $data[$modelId][static::DATA_SOURCE_DEFAULT][static::FIELD_MESSAGE_AVAILABLE] =
                $this->helperCalendar->getAlwaysShow(null, true);
    ...
    protected function customize(array $meta)
    {
        ...
        $tooltip = [
            'description' => __(
                'If set to yes calendar will always be shown. This settings does not work with times enabled.'
            ),
        ];
