 ...
 */
class AllowOverbooking extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_allow_overbooking';
    ...
    public function modifyData(array $data)
    {
        ...
        if ('' === $value || $value == \SalesIgniter\Rental\Helper\Data::USE_CONFIG_DEFAULT) {
            $data[$modelId][static::DATA_SOURCE_DEFAULT][static::FIELD_MESSAGE_AVAILABLE] =
                $this->helperCalendar->allowOverbooking(null, true);
    ...
    protected function customize(array $meta)
    {
        ...
        $tooltip = [
            'description' => __(
                'If set to yes overbooking is allowed for this product'
            ),
        ];
