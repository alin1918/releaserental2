 ...
 */
class SpecialPricingRules extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_special_rules';
    ...
    /**
     * @var \SalesIgniter\Rental\Model\Attribute\Sources\SpecialPricingRules
     */
    private $specialPricingRules;

    /**
     * @param LocatorInterface                                                 $locator
     * @param ArrayManager                                                     $arrayManager
     * @param ScopeConfigInterface                                             $scopeConfig
     * @param \SalesIgniter\Rental\Model\Attribute\Sources\SpecialPricingRules $specialPricingRules
    ...
    public function __construct(
        ...
        \SalesIgniter\Rental\Model\Attribute\Sources\SpecialPricingRules $specialPricingRules,
        ...
        $this->specialPricingRules = $specialPricingRules;
    }
    ...
    public function modifyData(array $data)
    {
        ...
        if ('' === $value || in_array(\SalesIgniter\Rental\Helper\Data::USE_CONFIG_DEFAULT, $value)) {
            $data[$modelId][static::DATA_SOURCE_DEFAULT][static::FIELD_MESSAGE_AVAILABLE] =
                $this->helperCalendar->getSpecialPricingRules(null, true);
                        ...
                        'arguments' => [
                            'data' => [
                                'config' => [
                                    ...
                                    'options' => $this->specialPricingRules->getOptionsArray(),
                                    'componentType' => Field::NAME,
                                    'component' => 'SalesIgniter_Rental/js/form/element/rental-excluded',
                                ],
                            ],
                        ],
                    ],
