...
use SalesIgniter\Rental\Model\Attribute\Sources\FixedType;

/**
 * Class GiftMessageDataProvider
 */
class FixedSelectionType extends AbstractModifier
{
    const FIELD_MESSAGE_AVAILABLE = 'sirent_fixed_type';
    ...
    public function modifyData(array $data)
    {
        ...
        $fixedOptions = $this->helperCalendar->getFixedOptions();
