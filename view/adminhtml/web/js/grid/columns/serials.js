...
define([
    ...
    return Column.extend({
        defaults: {
            ...
            rowIndex: 0,
            listens: {
                /*'${ $.provider }:params.posted_serials': 'onInputValue'*//*this is for live updates like on changing the input the grid is rendered again*/
                //      posted_serials_val: 'onInputValue'
        ...
        setRowIndex: function (index) {
            return ko.computed({
                read: function () {
                    return this.posted_serials[index];
                },
                write: function (inp_value) {
                    this.posted_serials[index] = inp_value;
                }
            }, this);
        },
        /**
         ...
         * @returns {Object}
         */
        getPostedSerials: function () {
            return this.posted_serials;
        }
