 ...
 */
class ReturnOverdueSender extends Sender
{
     ...
     * @param \SalesIgniter\Rental\Model\Emails\ReturnIdentity      $identityContainer
    ...
    public function __construct(
        ...
        ReturnOverdueIdentity $identityContainer,
    ...
    public function send(
        ...
        $this->eventManager->dispatch(
            'sirent_return_set_template_vars_before',
