...
class ReturnOverdueIdentity extends Container
{
    ...
    const XML_PATH_EMAIL_TEMPLATE = 'salesigniter_rental/emails/overdue_reminder_template';
    const XML_PATH_EMAIL_ENABLED = 'salesigniter_rental/emails/overdue_reminder_enable';
