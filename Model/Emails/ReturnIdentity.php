...
class ReturnIdentity extends Container
{
    ...
    const XML_PATH_EMAIL_TEMPLATE = 'salesigniter_rental/emails/return_confirmation_template';
    const XML_PATH_EMAIL_ENABLED = 'salesigniter_rental/emails/return_enable';
